...
# images
playerImage = pygame.image.load('cargit1.png')
car3 = pygame.image.load('cargit3.png')
car4 = pygame.image.load('cargit4.png')
playerRect = playerImage.get_rect()
baddieImage = pygame.image.load('cargit2.png')
